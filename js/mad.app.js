var Mad = (function ($) {
          ...
          if (tpj('#rev_slider_1_1').revolution == undefined) {
            ...
            revapi2 = tpj('#rev_slider_1_1')
              ...
              .revolution({
                sliderType: 'standard',
                jsFileLocation:
                  '//velikorodnov.com/temp/17/revslider/public/assets/js/',
                sliderLayout: 'auto',
                dottedOverlay: 'none',
                delay: 9500,
                navigation: {
  ...
  App.baseOwlSettings = {
    ...
    navText: App.RTL
      ? [
          '<img class="svg" src="yummi_svg_icons/arrow_left.svg" alt="">',
  ...
  App.helpers.fullScreenArea = {
    init: function (config) {
      ...
      this.defPaddingBottom = parseInt(
        this.collection.css('padding-bottom'),
        10
      )
    ...
    updateDocumentState: function () {
      ...
      this.eH =
        this.config.except && this.config.except.length
          ? this.getTotalHeightOfExceptedElements()
          : 0
      this.documentPadding =
        parseInt(this.$body.css('padding-top'), 10) +
        parseInt(this.$body.css('padding-bottom'), 10)

      this.wH = this.w.height()
    },

    getTotalHeightOfExceptedElements: function () {
      return this.config.except
        .toArray()
    ...
    run: function () {
      ...
      this.timeoutId = setTimeout(function () {
        if (self.cH < self.wH) {
          ...
          self.collection.css({
            'padding-top':
              diff + self.defPaddingTop - (self.eH + self.documentPadding) / 2,
            'padding-bottom':
              diff +
              self.defPaddingBottom -
              (self.eH + self.documentPadding) / 2,
          })
        }
